    ...
    <div class="container mt-5">
        ...
        <div class="wrap mx-width-600">
            ...
            <form method="post" action="">
                ...
                <?php endif; ?>
	            <?php wp_nonce_field('chatgpt_assistant_key_nonce', 'chatgpt_assistant_key_nonce_field'); ?>
            </form>
        </div>
        <div id="chatgpt_assistant_settings_wrapper" class="wrap" style="max-width: 70%">
            ...
            <div class="row g-2">
                ...
                <div class="mb-3 col-auto mn-width-400">
                    <input type="text" class="form-control" id="companyNameTextarea" placeholder="Example Company" value="<?php echo esc_attr(get_option('companyNameTextarea')); ?>">
                </div>
                <div class="mb-3 col-auto mn-width-400">
                ...
                <div class="mb-3 col-auto mn-width-400">
                    <textarea class="form-control" id="companyInfoTextarea" rows="4"><?php echo esc_textarea(get_option('companyInfoTextarea')); ?></textarea>
                </div>
                <div class="mb-3 col-auto mn-width-400">
            ...
            <div class="row g-2">
                ...
                <div class="mb-3 col-auto mn-width-400">
                    <textarea class="form-control" id="brandGuideTextarea" rows="4"><?php echo esc_textarea(get_option('brandGuideTextarea')); ?></textarea>
                </div>
                <div class="mb-3 col-auto mn-width-400">
	        ...
	        <?php wp_nonce_field('chatgpt_assistant_settings_nonce', 'chatgpt_assistant_settings_nonce_field'); ?>
...
function chatgpt_assistant_setting_action_callback() {
    ...
    // Check if the chatgpt_assistant_setting_value parameter is set
    if (isset($_POST['chatgpt_assistant_setting_value'])) {
        // Get the value of the setting from the request
        $chatgpt_assistant_setting_value = sanitize_text_field($_POST['chatgpt_assistant_setting_value']);

        // Update the setting in the database
        update_option(sanitize_key($_POST['chatgpt_assistant_setting_key']), $chatgpt_assistant_setting_value);
...
function chatgpt_assistant_setting_remove_callback() {
    ...
    // Check if the chatgpt_assistant_setting_value parameter is set
    if (isset($_POST['chatgpt_assistant_setting_key'])) {

        // Update the setting in the database
	    delete_option(sanitize_key($_POST['chatgpt_assistant_setting_key']));
