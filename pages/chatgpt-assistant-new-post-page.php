            ...
            <div id="building_the_post_step" class="content" role="tabpanel" aria-labelledby="building_the_post_step-trigger">
                <div class="container mt-1">
                    ...
                    <div id="chatgpt_assistant_new_post_wrapper" class="wrap" style="max-width: 70%">
	                    ...
	                    <?php wp_nonce_field('chatgpt_assistant_ajax_nonce', 'chatgpt_assistant_ajax_nonce_field'); ?>
            ...
            <div id="description_post_step" class="content" role="tabpanel" aria-labelledby="description_post_step-trigger">
                <div class="container mt-5">
                    ...
                    <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
                        <input type="hidden" name="action" value="chatgpt_assistant_publish_post_from_form">
	                    ...
	                    <?php wp_nonce_field('chatgpt_assistant_post_nonce', 'chatgpt_assistant_post_nonce_field'); ?>
                    </form>
                </div>
            </div>
        </div>
...
function chatgpt_assistant_publish_post_from_form()
{
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (isset($_POST['chatpgt_assistant_post_title']) && isset($_POST['chatpgt_assistant_editor'])) {
	        ...
	        $editor_content = sanitize_textarea_field($_POST['chatpgt_assistant_editor']);
            ...
            $data = array(
                ...
                'raw_response' => serialize(json_decode(stripslashes(sanitize_text_field($_POST['responseDataRaw'])), true))
            );
...
add_action('admin_init', 'chatgpt_assistant_publish_post_from_form' );